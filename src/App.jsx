...
export default function App() {
  ...
  return <>
    ...
    <main id="top">
      <section className="hero"><div className="eyebrow"><i /> AVAILABLE FOR SELECT PROJECTS</div><h1>Digital work<br />with a <em>human</em> pulse.</h1><div className="hero-bottom"><p>{profile.role}.<br />{profile.location}.</p><button className="round-link" onClick={() => goto('Work')} aria-label="View selected work"><ArrowDownRight /></button></div></section>
